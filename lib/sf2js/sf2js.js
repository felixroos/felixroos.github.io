...
const tc2s = (timecents) => Math.pow(2, timecents / 1200); // timecents to seconds
const s2tc = (seconds) => Math.round(Math.log2(seconds) * 1200); // seconds to timecents
const normalizePermille = (permille) => permille / 1000;
