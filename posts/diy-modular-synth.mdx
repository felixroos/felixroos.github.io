...
I used [2 of those](https://schneidersladen.de/en/sb-rail-19-with-lip) + [threaded strips](https://schneidersladen.de/en/threaded-strip-with-m3-threads-84hp)
To get the 3U distanc exactly right, you can use any two [panels](https://syntaxis.com.pl/en/panel/130-panel-8-16.html).
