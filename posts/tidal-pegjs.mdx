...
<Player
  ...
  events={[
    ...q(0, 2, 3, 'drums', '[[[bd ~ bd] sn] [bd bd sn],hh*12]'),
    ...q(0, 2, 3, 'piano', '[[C2 G1]*3 [Bb1 G1 Bb1]]'),
    ...q(0, 2, 3, 'piano', '[[E3,G3,B3] [[F3,G3,Bb3] ~ [F3,Ab3,Bb3]]]'),
  ]}
/>
```
...
```json
{
  "parallel": [
    ...
    { "instrument": "piano", "tidal": "[[C2 G1]*3 [Bb1 G1 Bb1]]" },
    { "instrument": "piano", "tidal": "[[E3,G3,B3] [[F3,G3,Bb3] ~ [F3,Ab3,Bb3]]]" }
  ]
}
```
...
To be generate events, the grammar generates the AST which is used as an intermediate representation.
...
import { unifyPattern, pData, pDataUnified, unifiedPattern, q } from '../components/tidal.pegjs/TidalSandbox.tsx';
